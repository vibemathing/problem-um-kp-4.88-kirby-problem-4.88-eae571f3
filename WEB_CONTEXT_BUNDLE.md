...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-4.88-kirby-problem-4.88-eae571f3-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-4.88"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-4.88-kirby-problem-4.88-eae571f3-v1",
      "problem_contract_sha256": "36963951c0d0f5e950540e3c95bbed9ef73c5ca8860b38a203fd1b232a7a2abd",
      "problem_id": "problem:um-kp-4.88-kirby-problem-4.88-eae571f3",
      "route_id": "route:um-kp-4.88-kirby-problem-4.88-eae571f3-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-4.88-kirby-problem-4.88-eae571f3-source-fidelity-01",
      "graph_id": "graph:um-kp-4.88-kirby-problem-4.88-eae571f3-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-4.88-kirby-problem-4.88-eae571f3-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-4.88-kirby-problem-4.88-eae571f3-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $\\tau: S^{4} \\to S^{4}$ be a free (hence orientation-reversing) involution. Is there an embedded $S^{2} \\subset S^{4}$ that is invariant under $\\tau$? This is equivalent to the existence of an embedded $\\mathbb{RP}^{2}$ in $S^{4}/\\tau \\cong \\mathbb{RP}^{4}$, carrying the nontrivial class in $H_{2}(\\mathbb{RP}^{4};\\mathbb{Z}/2)$. This condition on the homology class will be assumed for the rest of the problem."
          },
          "statement_sha256": "2d81d24db6bd0825a3fc03cc89cb0e8d9cce2ca19c28fb5ad516aa1e303e9b2e"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-4.88-kirby-problem-4.88-eae571f3-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-4.88-kirby-problem-4.88-eae571f3-root",
      "route_id": "route:um-kp-4.88-kirby-problem-4.88-eae571f3-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-4.88-121b4b42e8e4",
        "url": "https://www.unsolvedmath.com/problems/KP-4.88"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
